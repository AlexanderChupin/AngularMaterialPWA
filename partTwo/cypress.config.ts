...
export default defineConfig({
  ...
  e2e: {
    env: {
      ...
      "wbEndpoint": 'https://user-geo-data.wildberries.ru/get-geo-info?currency=RUB&latitude=55.753737&longitude=37.6201&locale=ru&address=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0'},
